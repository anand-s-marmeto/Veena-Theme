      ...
      size: function(ortags, product) {
        ...
        ortags.filter(function(tag) {
          product.variants.forEach(function(variant) {
            if(     (variant.option1 && _this.helpers().handleize(tag) == _this.helpers().handleize(variant.option1) && variant.available)
              || (variant.option2 && _this.helpers().handleize(tag) == _this.helpers().handleize(variant.option2) && variant.available)
              || (variant.option3 && _this.helpers().handleize(tag) == _this.helpers().handleize(variant.option3) && variant.available)
              ) {
              or = true;
            }
          })
        ...
        // }
          ...
          <div class="product-card-info">
            ...
            <div class="product-in-stock">
              <span class="in-stock" style="color: green ;">${ product.variants[0].inventory_quantity } in stock</span>
            </div>
          </div>
